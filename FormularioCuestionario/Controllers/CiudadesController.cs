...
namespace FormularioCuestionario.Controllers
{
    public class CiudadesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdCiudad,NombreCiudad,Instructor,IdCiudadPadron")] Ciudades ciudades)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdCiudad,NombreCiudad,Instructor,IdCiudadPadron")] Ciudades ciudades)
        {
            if (ModelState.IsValid)
            {
